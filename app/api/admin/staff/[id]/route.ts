 ...
 *
 * PURPOSE:
 * Get, update, and delete staff member details.
 *
 * USER STORIES SATISFIED:
 * - CSA-133: View & edit staff account details
 * - CSA-134: Add or remove staff accounts (delete)
 *
 * SECURITY:
 * - Requires manager or admin role (GET/PATCH)
 * - Requires admin role only (DELETE)
...
export async function DELETE(
  ...
  try {
    ...
    // Do not allow deleting other admins through this endpoint
    ...
    // Ensure service role key is present
